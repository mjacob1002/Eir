...
class Test_RandMoveSEIRS(unittest.TestCase):
    ...
    def checkInputs(self):
        ...
        self.assertRaises(e.ProbabilityException, RandMoveSEIRS, 999, 1, 1, 0, 1.25, .3, .2, 25, 3, .3, 1, .25, 31, 1.0, 2.0)
        self.assertRaises(e.ProbabilityException, RandMoveSEIRS, 999, 1, 1, 0, .25, .3, 1.2, 25, 3, .3, 1, .25, 31, 1.0, 2.0)
