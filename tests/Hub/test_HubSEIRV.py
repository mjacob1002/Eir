...
class Test_HubSEIRV(unittest.TestCase):
    
    def __init__(self):
        self.test = HubSEIRV(S0=999, E0=1, I0=1, R0=0, V0=0, pss=.23, rho=.2, gamma=.15, eta=.02, side=25, rstart=3, days=31, w0=.73, alpha=2)
        self.sdetails = self.test.run()
    
    def generateCSV(self):
        """ How CSV was generated in order to ensure reproducibility."""
        df = self.test.toDataFrame()
        df.to_csv("HubSEIRV.csv", index=False)
    
    def checkOutputs(self):
        df = self.test.toDataFrame()
        df2 = pd.read_csv("HubSEIRV.csv")
    ...
    def checkInput(self):
        ...
        self.assertRaises(e.NotIntException, HubSEIRV, 999.0, 1, 1, 0, 0, .23, .2, .15, .2, 25, 3, 31, 1.0, 6**0.5, 2, 1)
        self.assertRaises(e.NotIntException, HubSEIRV, 999, 1.0, 1, 0, 0, .23, .2, .15, .2, 25, 3, 31, 1.0, 6**0.5, 2, 1)
        self.assertRaises(e.NotIntException, HubSEIRV, 999, 1, 1.0, 0, 0, .23, .2, .15, .2, 25, 3, 31, 1.0, 6**0.5, 2, 1)
        self.assertRaises(e.NotIntException, HubSEIRV, 999, 1, 1, 0.0, 0, .23, .2, .15, .2, 25, 3, 31, 1.0, 6**0.5, 2, 1)
        self.assertRaises(e.NotIntException, HubSEIRV, 999, 1, 1, 0, 0, .23, .2, .15, .2, 25, 3, 31.0, 1.0, 6**0.5, 2, 1)
        self.assertRaises(e.NotIntException, HubSEIRV, 999, 1, 1, 0, 0.0, .23, .2, .15, .2, 25, 3, 31.0, 1.0, 6**0.5, 2, 1)
        # checks for not float exception
        self.assertRaises(e.NotFloatException, HubSEIRV, 999, 1, 1, 0, 0, '.23', .2, .15, .2, 25, 3, 31, 1.0, 6**0.5, 2)
        self.assertRaises(e.NotFloatException, HubSEIRV, 999, 1, 1, 0, 0, .23, True, .15, .2, 25, 3, 31, 1.0, 6**0.5, 2)
        self.assertRaises(e.NotFloatException, HubSEIRV, 999, 1, 1, 0, 0, .23, .2, 'apples', .2, 25, 3, 31, 1.0, 6**0.5, 2)
        self.assertRaises(e.NotFloatException, HubSEIRV, 999, 1, 1, 0, 0, .23, .2, .15, .2, False, 3, 31, 1.0, 6**0.5, 2)
        self.assertRaises(e.NotFloatException, HubSEIRV, 999, 1, 1, 0, 0, .23, .2, .15, .2, 25, '0', 31, 1.0, 6**0.5, 2)
        ...
        self.assertRaises(e.ProbabilityException, HubSEIRV, 999, 1, 1, 0, 0, .23, 1.2, .15, .2, 25, 3, 31, 1.0, 6**0.5, 2)
        self.assertRaises(e.ProbabilityException, HubSEIRV, 999, 1, 1, 0, 0, 1.23, .2, .15, .2, 25, 3, 31, 1.0, 6**0.5, 2)
        self.assertRaises(e.ProbabilityException, HubSEIRV, 999, 1, 1, 0, 0, .23, .2, .15, .2, 25, 3, 31, 1.1, 6**0.5, 2)
        self.assertRaises(e.ProbabilityException, HubSEIRV, 999, 1, 1, 0, 0, .23, .2, .15, 1.2, 25, 3, 31, 1.0, 6**0.5, 2)
