...
class SIR:
    ...
    def __simulate__(self, days: int, dt: float):
        ...
        S, I, R = self.__updateSIR__(dt, S, I, R)
        return S, I, R

    def __includeVar__(self, sx: bool, ix: bool, rx: bool):
    ...
    def run(self, days: int, dt: float, plot=True, Sbool=True, Ibool=True, Rbool=True):
        ...
        S, I, R = self.__simulate__(days, dt)
        ...
        if plot:
            ...
            included = self.__includeVar__(Sbool, Ibool, Rbool)
